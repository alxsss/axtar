...
/**
 * This class defines the structure of the 'biznes_rate' table.
 *
 *
 * This class was autogenerated by Propel 1.6.7 on:
 *
 * Fri Jan  9 02:13:19 2015
 *
 *
 ...
 */
class BiznesRateTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.BiznesRateTableMap';
    ...
    {
        // attributes
        $this->setName('biznes_rate');
        $this->setPhpName('BiznesRate');
        $this->setClassname('BiznesRate');
        ...
        $this->addColumn('RATE', 'Rate', 'INTEGER', false, null, null);
        $this->addColumn('CREATED_AT', 'CreatedAt', 'TIMESTAMP', false, null, null);
        $this->addColumn('CHECKED', 'Checked', 'BOOLEAN', false, 1, false);
