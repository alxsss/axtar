...
/**
 * This class defines the structure of the 'biznes_fav' table.
 *
 *
 ...
 */
class BiznesFavTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.BiznesFavTableMap';
    ...
    {
        // attributes
        $this->setName('biznes_fav');
        $this->setPhpName('BiznesFav');
        $this->setClassname('BiznesFav');
