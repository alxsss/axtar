...
abstract class BaseAdvertise extends BaseObject implements Persistent
{
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = AdvertisePeer::NAME;
        }
    ...
    public function setCompany($v)
    {
        ...
        if ($this->company !== $v) {
            $this->company = $v;
            $this->modifiedColumns[] = AdvertisePeer::COMPANY;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = AdvertisePeer::EMAIL;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[] = AdvertisePeer::PHONE;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = AdvertisePeer::COMMENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = AdvertisePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdvertiseQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AdvertisePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(AdvertisePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(AdvertisePeer::COMPANY)) {
            $modifiedColumns[':p' . $index++]  = '`COMPANY`';
        }
        if ($this->isColumnModified(AdvertisePeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`EMAIL`';
        }
        if ($this->isColumnModified(AdvertisePeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`PHONE`';
        }
        if ($this->isColumnModified(AdvertisePeer::COMMENT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `advertise` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Advertise'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Advertise'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdvertisePeer::NAME)) $criteria->add(AdvertisePeer::NAME, $this->name);
        if ($this->isColumnModified(AdvertisePeer::COMPANY)) $criteria->add(AdvertisePeer::COMPANY, $this->company);
        if ($this->isColumnModified(AdvertisePeer::EMAIL)) $criteria->add(AdvertisePeer::EMAIL, $this->email);
        if ($this->isColumnModified(AdvertisePeer::PHONE)) $criteria->add(AdvertisePeer::PHONE, $this->phone);
        if ($this->isColumnModified(AdvertisePeer::COMMENT)) $criteria->add(AdvertisePeer::COMMENT, $this->comment);
    ...
    {
        return (string) $this->exportTo(AdvertisePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseAdvertise:' . $name))
        {
