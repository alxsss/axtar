...
abstract class BaseSearchPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseSearchPeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to search
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SearchPeer::getOMClass(false);
	...
	{
		return $withPrefix ? SearchPeer::CLASS_DEFAULT : SearchPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSearchPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSearchPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSearchPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSearchPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSearchPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSearchPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSearchPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSearchPeer', $values, $con, $ret);
    }
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSearchPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
