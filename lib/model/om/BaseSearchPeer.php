...
abstract class BaseSearchPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SearchPeer::ID, SearchPeer::QUERY, SearchPeer::RAW_IP, SearchPeer::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'QUERY', 'RAW_IP', 'CREATED_AT', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SearchPeer::ID => 0, SearchPeer::QUERY => 1, SearchPeer::RAW_IP => 2, SearchPeer::CREATED_AT => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'QUERY' => 1, 'RAW_IP' => 2, 'CREATED_AT' => 3, ),
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(SearchPeer::ID);
            if ($value) {
                $selectCriteria->add(SearchPeer::ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the search table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
