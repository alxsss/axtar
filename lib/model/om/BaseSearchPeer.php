...
/**
 * Base static class for performing query and update operations on the 'search' table.
 *
 * 
 *
...
abstract class BaseSearchPeer {
	...
	const RAW_IP = 'search.RAW_IP';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'search.CREATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Query', 'RawIp', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'query', 'rawIp', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::QUERY, self::RAW_IP, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'query', 'raw_ip', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Query' => 1, 'RawIp' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'query' => 1, 'rawIp' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::QUERY => 1, self::RAW_IP => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'query' => 1, 'raw_ip' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SearchMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SearchPeer::QUERY);

		$criteria->addSelectColumn(SearchPeer::RAW_IP);
    ...
    foreach (sfMixer::getCallables('BaseSearchPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseSearchPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseSearchPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseSearchPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      Search $value A Search object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Search $obj, $key = null)
	{
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Search or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseSearchPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSearchPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
		...
		if ($criteria->containsKey(SearchPeer::ID) && $criteria->keyContainsValue(SearchPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SearchPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseSearchPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseSearchPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Search or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseSearchPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSearchPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseSearchPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseSearchPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the search table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Search or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof Search) {
			...
			foreach ((array) $values as $singleval) {
				...
				SearchPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = SearchPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the SearchPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SearchPeer class:
//
// Propel::getDatabaseMap(SearchPeer::DATABASE_NAME)->addTableBuilder(SearchPeer::TABLE_NAME, SearchPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseSearchPeer::DATABASE_NAME)->addTableBuilder(BaseSearchPeer::TABLE_NAME, BaseSearchPeer::getMapBuilder());
