...
abstract class BaseSponsorPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseSponsorPeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sponsor
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SponsorPeer::getOMClass(false);
	...
	{
		return $withPrefix ? SponsorPeer::CLASS_DEFAULT : SponsorPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSponsorPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSponsorPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSponsorPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSponsorPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSponsorPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSponsorPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSponsorPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSponsorPeer', $values, $con, $ret);
    }
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSponsorPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
