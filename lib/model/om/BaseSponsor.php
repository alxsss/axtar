...
abstract class BaseSponsor extends BaseObject  implements Persistent {
  ...
  const PEER = 'SponsorPeer';
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(SponsorPeer::PAYMENT))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = SponsorPeer::NUM_COLUMNS - SponsorPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(SponsorPeer::CREATED_AT))
    {
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPayment($this->payment);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseSponsor:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseSponsor::%s', $method));
    }
