...
abstract class BaseSponsor extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseSponsor object.
     * @see        applyDefaults()
     */
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = SponsorPeer::DESCRIPTION;
        }
    ...
    public function setStart($v)
    {
        ...
        if ($this->start !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorPeer::START;
            }
    ...
    public function setEnd($v)
    {
        ...
        if ($this->end !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorPeer::END;
            }
        } // if either are not null
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = SponsorPeer::EMAIL;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = SponsorPeer::COMMENT;
        }
    ...
    public function setPayment($v)
    {
        ...
        if ($this->payment !== $v) {
            $this->payment = $v;
            $this->modifiedColumns[] = SponsorPeer::PAYMENT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SponsorPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->payment = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            ...
            return $startcol + 10; // 10 = SponsorPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            foreach (sfMixer::getCallables('BaseSponsor:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseSponsor:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseSponsor:save:pre') as $callable)
            {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SponsorPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseSponsor:save:post') as $callable)
                {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SponsorPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`URL`';
        }
        if ($this->isColumnModified(SponsorPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`DESCRIPTION`';
        }
        if ($this->isColumnModified(SponsorPeer::START)) {
            $modifiedColumns[':p' . $index++]  = '`START`';
        }
        if ($this->isColumnModified(SponsorPeer::END)) {
            $modifiedColumns[':p' . $index++]  = '`END`';
        }
        if ($this->isColumnModified(SponsorPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`EMAIL`';
        }
        if ($this->isColumnModified(SponsorPeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`PHONE`';
        }
        if ($this->isColumnModified(SponsorPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`COMMENT`';
        }
        if ($this->isColumnModified(SponsorPeer::PAYMENT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `sponsor` (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) $this->setPayment($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SponsorPeer::DESCRIPTION)) $criteria->add(SponsorPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(SponsorPeer::START)) $criteria->add(SponsorPeer::START, $this->start);
        if ($this->isColumnModified(SponsorPeer::END)) $criteria->add(SponsorPeer::END, $this->end);
        if ($this->isColumnModified(SponsorPeer::EMAIL)) $criteria->add(SponsorPeer::EMAIL, $this->email);
        if ($this->isColumnModified(SponsorPeer::PHONE)) $criteria->add(SponsorPeer::PHONE, $this->phone);
        if ($this->isColumnModified(SponsorPeer::COMMENT)) $criteria->add(SponsorPeer::COMMENT, $this->comment);
        if ($this->isColumnModified(SponsorPeer::PAYMENT)) $criteria->add(SponsorPeer::PAYMENT, $this->payment);
        if ($this->isColumnModified(SponsorPeer::CREATED_AT)) $criteria->add(SponsorPeer::CREATED_AT, $this->created_at);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseSponsor:' . $name))
        {
