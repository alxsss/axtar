...
abstract class BaseUrl extends BaseObject implements Persistent
{
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = UrlPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = UrlPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UrlPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(UrlPeer::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UrlPeer::NAME)) $criteria->add(UrlPeer::NAME, $this->name);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseUrl:' . $name))
        {
