 ...
 <div id="veb_image_links_small">
  <a id="veb" href="<?php echo url_for('@search_search?query='.sfOutputEscaper::unescape($sf_request->getParameter('query')))?>"><?php echo __('aznet')?></a>
...
<form action="<?php echo url_for('@search_search') ?>" method="post">
  <input type="text" name="query" value="<?php echo sfOutputEscaper::unescape($sf_request->getParameter('query')) ?>" class="search_keywords" size="55" onfocus="this.value = this.value;" />
