 <div class="col-md-12 logo_search_box_xeber">
        ...
        <div class="col-xs-10 col-xs-offset-1 col-md-offset-0 col-md-5">
           ...
           <div class="col-xs-12">
             ...
             <div class="col-xs-2 col-lg-1">
              <a id="veb" href="<?php echo url_for('@search_www?query='.$sf_request->getParameter('query'))?>"><?php echo __('web')?></a>
             </div>
             <div class="col-xs-2 col-lg-1">
             ...
             <form action="<?php echo url_for('@search_www') ?>" method="post" class="search_form">
