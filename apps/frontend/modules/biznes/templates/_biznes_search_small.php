 <div class="col-md-12 logo_search_box_xeber">
        ...
        <div class="col-xs-10 col-xs-offset-1 col-md-offset-0 col-md-5">
           ...
           <div class="col-xs-12">
             ...
             <div class="col-xs-2 col-lg-1">
              <a id="veb" href="<?php echo url_for('@biznes_search?query='.sfOutputEscaper::unescape($sf_request->getParameter('query')))?>"><?php echo __('business')?></a>
            </div>
             ...
             <form action="<?php echo url_for('@biznes_search') ?>" method="post" class="search_form">
               <div class="col-xs-12 col-md-10 search_keywords">
                 <div class="col-xs-11 col-md-11">
                    <input type="text" name="query" value="<?php echo sfOutputEscaper::unescape(htmlspecialchars($sf_request->getParameter('query'), ENT_NOQUOTES)) ?>"  class="col-xs-12" id="biznes_query" onfocus="this.value = this.value;" />
                 </div>
