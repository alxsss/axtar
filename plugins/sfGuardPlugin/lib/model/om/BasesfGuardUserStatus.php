...
/**
 * Base class that represents a row from the 'sf_guard_user_status' table.
 *
 *
 *
 ...
 */
abstract class BasesfGuardUserStatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'sfGuardUserStatusPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        sfGuardUserStatusPeer
     */
     ...
     * @return sfGuardUserStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = sfGuardUserStatusPeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = sfGuardUserStatusPeer::USER_ID;
        }
    ...
    public function setStatusName($v)
    {
        ...
        if ($this->status_name !== $v) {
            $this->status_name = $v;
            $this->modifiedColumns[] = sfGuardUserStatusPeer::STATUS_NAME;
        }
    ...
    public function setNumComment($v)
    {
        ...
        if ($this->num_comment !== $v) {
            $this->num_comment = $v;
            $this->modifiedColumns[] = sfGuardUserStatusPeer::NUM_COMMENT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = sfGuardUserStatusPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->status_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = sfGuardUserStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating sfGuardUserStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = sfGuardUserStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = sfGuardUserStatusQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BasesfGuardUserStatus:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BasesfGuardUserStatus:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BasesfGuardUserStatus:save:pre') as $callable)
            {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(sfGuardUserStatusPeer::CREATED_AT))
                {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BasesfGuardUserStatus:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                sfGuardUserStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(sfGuardUserStatusPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(sfGuardUserStatusPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(sfGuardUserStatusPeer::STATUS_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`STATUS_NAME`';
        }
        if ($this->isColumnModified(sfGuardUserStatusPeer::NUM_COMMENT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `sf_guard_user_status` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = sfGuardUserStatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = sfGuardUserStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['sfGuardUserStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['sfGuardUserStatus'][$this->getPrimaryKey()] = true;
        $keys = sfGuardUserStatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUserId(),
            $keys[2] => $this->getStatusName(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setStatusName($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardUserStatusPeer::ID)) $criteria->add(sfGuardUserStatusPeer::ID, $this->id);
        if ($this->isColumnModified(sfGuardUserStatusPeer::USER_ID)) $criteria->add(sfGuardUserStatusPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(sfGuardUserStatusPeer::STATUS_NAME)) $criteria->add(sfGuardUserStatusPeer::STATUS_NAME, $this->status_name);
        if ($this->isColumnModified(sfGuardUserStatusPeer::NUM_COMMENT)) $criteria->add(sfGuardUserStatusPeer::NUM_COMMENT, $this->num_comment);
        if ($this->isColumnModified(sfGuardUserStatusPeer::CREATED_AT)) $criteria->add(sfGuardUserStatusPeer::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(sfGuardUserStatusPeer::DATABASE_NAME);
        $criteria->add(sfGuardUserStatusPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of sfGuardUserStatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return sfGuardUserStatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return sfGuardUserStatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new sfGuardUserStatusPeer();
        }
    ...
    public function getsfGuardUser(PropelPDO $con = null)
    {
        if ($this->asfGuardUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->asfGuardUser->addsfGuardUserStatuss($this);
             */
        }
     ...
     * If this sfGuardUserStatus is new, it will return
        ...
        if (null === $this->collsfGuardUserStatusComments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collsfGuardUserStatusComments) {
                ...
                $collsfGuardUserStatusComments = sfGuardUserStatusCommentQuery::create(null, $criteria)
                    ->filterBysfGuardUserStatus($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setsfGuardUserStatusComments(PropelCollection $sfGuardUserStatusComments, PropelPDO $con = null)
    {
        ...
        foreach ($this->sfGuardUserStatusCommentsScheduledForDeletion as $sfGuardUserStatusCommentRemoved) {
            $sfGuardUserStatusCommentRemoved->setsfGuardUserStatus(null);
        }
    ...
    protected function doAddsfGuardUserStatusComment($sfGuardUserStatusComment)
    {
        ...
        $sfGuardUserStatusComment->setsfGuardUserStatus($this);
    }
    ...
    public function removesfGuardUserStatusComment($sfGuardUserStatusComment)
    {
        if ($this->getsfGuardUserStatusComments()->contains($sfGuardUserStatusComment)) {
            ...
            $sfGuardUserStatusComment->setsfGuardUserStatus(null);
        }
    }
     ...
     * Otherwise if this sfGuardUserStatus is new, it will return
     * an empty collection; or if this sfGuardUserStatus has previously
     * been saved, it will retrieve related sfGuardUserStatusComments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in sfGuardUserStatus.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|sfGuardUserStatusComment[] List of sfGuardUserStatusComment objects
     */
    public function getsfGuardUserStatusCommentsJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = sfGuardUserStatusCommentQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(sfGuardUserStatusPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BasesfGuardUserStatus:' . $name))
        {
