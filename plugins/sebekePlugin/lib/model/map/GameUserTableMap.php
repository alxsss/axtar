...
/**
 * This class defines the structure of the 'game_user' table.
 *
 *
 ...
 */
class GameUserTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.GameUserTableMap';
    ...
    {
        // attributes
        $this->setName('game_user');
        $this->setPhpName('GameUser');
        $this->setClassname('GameUser');
