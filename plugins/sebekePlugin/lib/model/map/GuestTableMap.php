...
class GuestTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.GuestTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('GUEST_ID', 'GuestId', 'INTEGER', 'sf_guard_user', 'ID', false, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('sfGuardUserRelatedByGuestId', 'sfGuardUser', RelationMap::MANY_TO_ONE, array('guest_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
