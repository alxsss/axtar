...
class PlaylistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.PlaylistTableMap';
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('PlaylistComment', 'PlaylistComment', RelationMap::ONE_TO_MANY, array('id' => 'playlist_id', ), 'CASCADE', null, 'PlaylistComments');
        $this->addRelation('PlaylistFav', 'PlaylistFav', RelationMap::ONE_TO_MANY, array('id' => 'playlist_id', ), 'CASCADE', null, 'PlaylistFavs');
        $this->addRelation('PlaylistMusic', 'PlaylistMusic', RelationMap::ONE_TO_MANY, array('id' => 'playlist_id', ), 'CASCADE', 'CASCADE', 'PlaylistMusics');
    } // buildRelations()
