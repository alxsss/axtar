...
/**
 * This class defines the structure of the 'playlist_comment' table.
 *
 *
 ...
 */
class PlaylistCommentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.PlaylistCommentTableMap';
    ...
    {
        // attributes
        $this->setName('playlist_comment');
        $this->setPhpName('PlaylistComment');
        $this->setClassname('PlaylistComment');
