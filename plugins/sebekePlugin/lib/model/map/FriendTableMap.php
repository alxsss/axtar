...
class FriendTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.FriendTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('FRIEND_ID', 'FriendId', 'INTEGER', 'sf_guard_user', 'ID', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('sfGuardUserRelatedByFriendId', 'sfGuardUser', RelationMap::MANY_TO_ONE, array('friend_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
