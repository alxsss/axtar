...
/**
 * This class defines the structure of the 'photo_fav' table.
 *
 *
 ...
 */
class PhotoFavTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.PhotoFavTableMap';
    ...
    {
        // attributes
        $this->setName('photo_fav');
        $this->setPhpName('PhotoFav');
        $this->setClassname('PhotoFav');
