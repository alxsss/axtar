...
/**
 * This class defines the structure of the 'photo_rate' table.
 *
 *
 ...
 */
class PhotoRateTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.PhotoRateTableMap';
    ...
    {
        // attributes
        $this->setName('photo_rate');
        $this->setPhpName('PhotoRate');
        $this->setClassname('PhotoRate');
