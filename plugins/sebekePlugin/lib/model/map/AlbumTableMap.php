...
class AlbumTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.AlbumTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('VISIBILITY', 'Visibility', 'INTEGER', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Photo', 'Photo', RelationMap::ONE_TO_MANY, array('id' => 'album_id', ), 'CASCADE', null, 'Photos');
    } // buildRelations()
