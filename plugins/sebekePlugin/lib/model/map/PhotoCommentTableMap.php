...
/**
 * This class defines the structure of the 'photo_comment' table.
 *
 *
...
class PhotoCommentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'plugins.sebekePlugin.lib.model.map.PhotoCommentTableMap';
