...
abstract class BaseCountryPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ISO_CODE_2, self::ISO_CODE_3, self::ADDRESS_FORMAT_ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ISO_CODE_2 => 2, self::ISO_CODE_3 => 3, self::ADDRESS_FORMAT_ID => 4, ),
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in RegionPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(RegionPeer::COUNTRY_ID, $obj->getId());
			$affectedRows += RegionPeer::doDelete($c, $con);

			// delete related sfGuardUserProfile objects
			$c = new Criteria(sfGuardUserProfilePeer::DATABASE_NAME);
			
			$c->add(sfGuardUserProfilePeer::COUNTRY_ID, $obj->getId());
