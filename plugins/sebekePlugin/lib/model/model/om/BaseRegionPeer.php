...
abstract class BaseRegionPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RegionPeer::COUNTRY_ID);
	...
	public static function doCountJoinCountry(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(RegionPeer::COUNTRY_ID,), array(CountryPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Region objects pre-filled with their Country objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseRegionPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseRegionPeer', $c, $con);
		...
		$c->addJoin(array(RegionPeer::COUNTRY_ID,), array(CountryPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Region) to $obj2 (Country)
				$obj2->addRegion($obj1);
    ...
    foreach (sfMixer::getCallables('BaseRegionPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseRegionPeer', $c, $con);
    }
		...
		RegionPeer::addSelectColumns($c);
		$startcol2 = (RegionPeer::NUM_COLUMNS - RegionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Region) to the collection in $obj2 (Country)
				$obj2->addRegion($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += RegionPeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in VillagePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Village objects
			$c = new Criteria(VillagePeer::DATABASE_NAME);
			
			$c->add(VillagePeer::REGION_ID, $obj->getId());
			$affectedRows += VillagePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
