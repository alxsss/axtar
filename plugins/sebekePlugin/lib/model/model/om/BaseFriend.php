...
abstract class BaseFriend extends BaseObject  implements Persistent {
  ...
  const PEER = 'FriendPeer';
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(FriendPeer::APPROVED))) {
				return false;
			}
	...
	public function getsfGuardUserRelatedByFriendId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByFriendId === null && ($this->friend_id !== null)) {
			$c = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$c->add(sfGuardUserPeer::ID, $this->friend_id);
			$this->asfGuardUserRelatedByFriendId = sfGuardUserPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
