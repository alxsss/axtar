...
abstract class BaseMessagePeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::SUBJECT, self::FROM_USERID, self::TO_USERID, self::FROM_DELTYPE, self::TO_DELTYPE, self::CREATED_AT, self::MSGTEXT, self::READ_UNREAD, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SUBJECT => 1, self::FROM_USERID => 2, self::TO_USERID => 3, self::FROM_DELTYPE => 4, self::TO_DELTYPE => 5, self::CREATED_AT => 6, self::MSGTEXT => 7, self::READ_UNREAD => 8, ),
	...
	public static function doCountJoinsfGuardUserRelatedByFromUserid(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(MessagePeer::FROM_USERID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinsfGuardUserRelatedByToUserid(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(MessagePeer::TO_USERID,), array(sfGuardUserPeer::ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinsfGuardUserRelatedByFromUserid(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
    ...
    foreach (sfMixer::getCallables('BaseMessagePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseMessagePeer', $c, $con);
		...
		$c->addJoin(array(MessagePeer::FROM_USERID,), array(sfGuardUserPeer::ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinsfGuardUserRelatedByToUserid(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(MessagePeer::TO_USERID,), array(sfGuardUserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptsfGuardUserRelatedByFromUserid(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptsfGuardUserRelatedByToUserid(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
