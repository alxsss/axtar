...
abstract class BasePlaylist extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = PlaylistPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function setPlaylistComments(PropelCollection $playlistComments, PropelPDO $con = null)
    {
        ...
        foreach ($this->playlistCommentsScheduledForDeletion as $playlistCommentRemoved) {
            $playlistCommentRemoved->setPlaylist(null);
        }
    ...
    protected function doAddPlaylistComment($playlistComment)
    {
        ...
        $playlistComment->setPlaylist($this);
    }
    ...
    public function removePlaylistComment($playlistComment)
    {
        if ($this->getPlaylistComments()->contains($playlistComment)) {
            ...
            $playlistComment->setPlaylist(null);
        }
    }
     ...
     * @return PropelObjectCollection|PlaylistComment[] List of PlaylistComment objects
     */
    public function getPlaylistCommentsJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PlaylistCommentQuery::create(null, $criteria);
    ...
    public function setPlaylistFavs(PropelCollection $playlistFavs, PropelPDO $con = null)
    {
        ...
        foreach ($this->playlistFavsScheduledForDeletion as $playlistFavRemoved) {
            $playlistFavRemoved->setPlaylist(null);
        }
     ...
     * @return PropelObjectCollection|PlaylistFav[] List of PlaylistFav objects
     */
    public function getPlaylistFavsJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PlaylistFavQuery::create(null, $criteria);
        $query->joinWith('sfGuardUser', $join_behavior);
    ...
    public function setPlaylistMusics(PropelCollection $playlistMusics, PropelPDO $con = null)
    {
        ...
        foreach ($this->playlistMusicsScheduledForDeletion as $playlistMusicRemoved) {
            $playlistMusicRemoved->setPlaylist(null);
        }
     ...
     * @return PropelObjectCollection|PlaylistMusic[] List of PlaylistMusic objects
     */
    public function getPlaylistMusicsJoinMusic($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PlaylistMusicQuery::create(null, $criteria);
        $query->joinWith('Music', $join_behavior);
