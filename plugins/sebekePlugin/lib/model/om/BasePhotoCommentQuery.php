...
/**
 * Base class that represents a query for the 'photo_comment' table.
 *
 *
 *
 ...
 * @method PhotoCommentQuery orderByComment($order = Criteria::ASC) Order by the comment column
 * @method PhotoCommentQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method PhotoCommentQuery orderByRawIp($order = Criteria::ASC) Order by the raw_ip column
 ...
 * @method PhotoCommentQuery groupByComment() Group by the comment column
 * @method PhotoCommentQuery groupByCreatedAt() Group by the created_at column
 * @method PhotoCommentQuery groupByRawIp() Group by the raw_ip column
 ...
 *
 * @method PhotoCommentQuery leftJoinsfGuardUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the sfGuardUser relation
 * @method PhotoCommentQuery rightJoinsfGuardUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the sfGuardUser relation
 * @method PhotoCommentQuery innerJoinsfGuardUser($relationAlias = null) Adds a INNER JOIN clause to the query using the sfGuardUser relation
 *
 ...
 * @method PhotoComment findOneById(int $id) Return the first PhotoComment filtered by the id column
 * @method PhotoComment findOneByComment(string $comment) Return the first PhotoComment filtered by the comment column
 * @method PhotoComment findOneByCreatedAt(string $created_at) Return the first PhotoComment filtered by the created_at column
 * @method PhotoComment findOneByRawIp(string $raw_ip) Return the first PhotoComment filtered by the raw_ip column
 ...
 * @method array findByComment(string $comment) Return PhotoComment objects filtered by the comment column
 * @method array findByCreatedAt(string $created_at) Return PhotoComment objects filtered by the created_at column
 * @method array findByRawIp(string $raw_ip) Return PhotoComment objects filtered by the raw_ip column
...
abstract class BasePhotoCommentQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'propel', $modelName = 'PhotoComment', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `PHOTO_ID`, `ID`, `COMMENT`, `CREATED_AT`, `RAW_IP`, `USER_ID` FROM `photo_comment` WHERE `ID` = :p0';
        try {
    ...
    public function filterByComment($comment = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PhotoCommentPeer::COMMENT, $comment, $comparison);
    }
    ...
    public function filterByRawIp($rawIp = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PhotoCommentPeer::RAW_IP, $rawIp, $comparison);
    }
    ...
    public function filterBysfGuardUser($sfGuardUser, $comparison = null)
    {
        if ($sfGuardUser instanceof sfGuardUser) {
            return $this
                ->addUsingAlias(PhotoCommentPeer::USER_ID, $sfGuardUser->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PhotoCommentPeer::USER_ID, $sfGuardUser->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
