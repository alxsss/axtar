 ...
 *
 * @method PlaylistQuery leftJoinsfGuardUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the sfGuardUser relation
 * @method PlaylistQuery rightJoinsfGuardUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the sfGuardUser relation
 * @method PlaylistQuery innerJoinsfGuardUser($relationAlias = null) Adds a INNER JOIN clause to the query using the sfGuardUser relation
 *
 * @method PlaylistQuery leftJoinPlaylistComment($relationAlias = null) Adds a LEFT JOIN clause to the query using the PlaylistComment relation
 * @method PlaylistQuery rightJoinPlaylistComment($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PlaylistComment relation
 * @method PlaylistQuery innerJoinPlaylistComment($relationAlias = null) Adds a INNER JOIN clause to the query using the PlaylistComment relation
 *
 * @method PlaylistQuery leftJoinPlaylistFav($relationAlias = null) Adds a LEFT JOIN clause to the query using the PlaylistFav relation
 * @method PlaylistQuery rightJoinPlaylistFav($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PlaylistFav relation
 * @method PlaylistQuery innerJoinPlaylistFav($relationAlias = null) Adds a INNER JOIN clause to the query using the PlaylistFav relation
 *
 * @method PlaylistQuery leftJoinPlaylistMusic($relationAlias = null) Adds a LEFT JOIN clause to the query using the PlaylistMusic relation
 * @method PlaylistQuery rightJoinPlaylistMusic($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PlaylistMusic relation
 * @method PlaylistQuery innerJoinPlaylistMusic($relationAlias = null) Adds a INNER JOIN clause to the query using the PlaylistMusic relation
 *
...
abstract class BasePlaylistQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NAME`, `USER_ID`, `CREATED_AT` FROM `playlist` WHERE `ID` = :p0';
        try {
    ...
    public function filterBysfGuardUser($sfGuardUser, $comparison = null)
    {
        if ($sfGuardUser instanceof sfGuardUser) {
            return $this
                ->addUsingAlias(PlaylistPeer::USER_ID, $sfGuardUser->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PlaylistPeer::USER_ID, $sfGuardUser->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByPlaylistComment($playlistComment, $comparison = null)
    {
        if ($playlistComment instanceof PlaylistComment) {
            return $this
                ->addUsingAlias(PlaylistPeer::ID, $playlistComment->getPlaylistId(), $comparison);
    ...
    public function filterByPlaylistFav($playlistFav, $comparison = null)
    {
        if ($playlistFav instanceof PlaylistFav) {
            return $this
                ->addUsingAlias(PlaylistPeer::ID, $playlistFav->getPlaylistId(), $comparison);
    ...
    public function filterByPlaylistMusic($playlistMusic, $comparison = null)
    {
        if ($playlistMusic instanceof PlaylistMusic) {
            return $this
                ->addUsingAlias(PlaylistPeer::ID, $playlistMusic->getPlaylistId(), $comparison);
