...
abstract class BaseAlbumPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ID, AlbumPeer::TITLE, AlbumPeer::DESCRIPTION, AlbumPeer::VISIBILITY, AlbumPeer::USER_ID, AlbumPeer::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'DESCRIPTION', 'VISIBILITY', 'USER_ID', 'CREATED_AT', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ID => 0, AlbumPeer::TITLE => 1, AlbumPeer::DESCRIPTION => 2, AlbumPeer::VISIBILITY => 3, AlbumPeer::USER_ID => 4, AlbumPeer::CREATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'DESCRIPTION' => 2, 'VISIBILITY' => 3, 'USER_ID' => 4, 'CREATED_AT' => 5, ),
    ...
    public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AlbumPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
