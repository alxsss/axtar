...
abstract class BaseAlbum extends BaseObject implements Persistent
{
    ...
    public function setVisibility($v)
    {
        ...
        if ($this->visibility !== $v) {
            $this->visibility = $v;
            $this->modifiedColumns[] = AlbumPeer::VISIBILITY;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = AlbumPeer::USER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->visibility = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = AlbumPeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->photosScheduledForDeletion !== null) {
                if (!$this->photosScheduledForDeletion->isEmpty()) {
                    foreach ($this->photosScheduledForDeletion as $photo) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlbumPeer::VISIBILITY)) {
            $modifiedColumns[':p' . $index++]  = '`VISIBILITY`';
        }
        if ($this->isColumnModified(AlbumPeer::USER_ID)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setVisibility($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlbumPeer::VISIBILITY)) $criteria->add(AlbumPeer::VISIBILITY, $this->visibility);
        if ($this->isColumnModified(AlbumPeer::USER_ID)) $criteria->add(AlbumPeer::USER_ID, $this->user_id);
    ...
    public function getsfGuardUser(PropelPDO $con = null)
    {
        if ($this->asfGuardUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->asfGuardUser->addAlbums($this);
             */
        }
