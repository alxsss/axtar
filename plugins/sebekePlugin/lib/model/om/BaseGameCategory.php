...
/**
 * Base class that represents a row from the 'game_category' table.
 *
 *
 *
 ...
 */
abstract class BaseGameCategory extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'GameCategoryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GameCategoryPeer
     */
    ...
    /**
     * The value for the num_games field.
     * @var        int
     */
    protected $num_games;
    ...
    /**
     * Get the [num_games] column value.
     *
     * @return int
     */
     ...
     * @return GameCategory The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = GameCategoryPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = GameCategoryPeer::NAME;
        }
    ...
    public function setDisplayName($v)
    {
        ...
        if ($this->display_name !== $v) {
            $this->display_name = $v;
            $this->modifiedColumns[] = GameCategoryPeer::DISPLAY_NAME;
        }
    ...
    /**
     * Set the value of [num_games] column.
     *
     * @param int $v new value
     * @return GameCategory The current object (for fluent API support)
     */
    public function setNumGames($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->num_games !== $v) {
            $this->num_games = $v;
            $this->modifiedColumns[] = GameCategoryPeer::NUM_GAMES;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->num_games = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = GameCategoryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GameCategory object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GameCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GameCategoryQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseGameCategory:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseGameCategory:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseGameCategory:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseGameCategory:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                GameCategoryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GameCategoryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(GameCategoryPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }
        if ($this->isColumnModified(GameCategoryPeer::DISPLAY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`DISPLAY_NAME`';
        }
        if ($this->isColumnModified(GameCategoryPeer::NUM_GAMES)) {
            $modifiedColumns[':p' . $index++]  = '`NUM_GAMES`';
        }

        $sql = sprintf(
            'INSERT INTO `game_category` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`DISPLAY_NAME`':
                        ...
                        break;
                    case '`NUM_GAMES`':
                        $stmt->bindValue($identifier, $this->num_games, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GameCategoryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GameCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GameCategory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GameCategory'][$this->getPrimaryKey()] = true;
        $keys = GameCategoryPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getDisplayName(),
            $keys[3] => $this->getNumGames(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setNumGames($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GameCategoryPeer::ID)) $criteria->add(GameCategoryPeer::ID, $this->id);
        if ($this->isColumnModified(GameCategoryPeer::NAME)) $criteria->add(GameCategoryPeer::NAME, $this->name);
        if ($this->isColumnModified(GameCategoryPeer::DISPLAY_NAME)) $criteria->add(GameCategoryPeer::DISPLAY_NAME, $this->display_name);
        if ($this->isColumnModified(GameCategoryPeer::NUM_GAMES)) $criteria->add(GameCategoryPeer::NUM_GAMES, $this->num_games);
    ...
    {
        $criteria = new Criteria(GameCategoryPeer::DATABASE_NAME);
        $criteria->add(GameCategoryPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of GameCategory (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNumGames($this->getNumGames());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GameCategory Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GameCategoryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GameCategoryPeer();
        }
     ...
     * If this GameCategory is new, it will return
    ...
    {
        $this->gamesScheduledForDeletion = $this->getGames(new Criteria(), $con)->diff($games);

        foreach ($this->gamesScheduledForDeletion as $gameRemoved) {
            $gameRemoved->setGameCategory(null);
        }
    ...
    public function addGame(Game $l)
    {
        ...
        if (!$this->collGames->contains($l)) { // only add it if the **same** object is not already associated
            $this->doAddGame($l);
        }
    ...
    {
        return (string) $this->exportTo(GameCategoryPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseGameCategory:' . $name))
        {
