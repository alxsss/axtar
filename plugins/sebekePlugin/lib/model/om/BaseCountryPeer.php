...
abstract class BaseCountryPeer
{
    ...
    const ISO_CODE_2 = 'country.ISO_CODE_2';

    /** the column name for the ISO_CODE_3 field */
    const ISO_CODE_3 = 'country.ISO_CODE_3';

    /** the column name for the ADDRESS_FORMAT_ID field */
    const ADDRESS_FORMAT_ID = 'country.ADDRESS_FORMAT_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'IsoCode2', 'IsoCode3', 'AddressFormatId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'isoCode2', 'isoCode3', 'addressFormatId', ),
        BasePeer::TYPE_COLNAME => array (CountryPeer::ID, CountryPeer::NAME, CountryPeer::ISO_CODE_2, CountryPeer::ISO_CODE_3, CountryPeer::ADDRESS_FORMAT_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ISO_CODE_2', 'ISO_CODE_3', 'ADDRESS_FORMAT_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'iso_code_2', 'iso_code_3', 'address_format_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'IsoCode2' => 2, 'IsoCode3' => 3, 'AddressFormatId' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'isoCode2' => 2, 'isoCode3' => 3, 'addressFormatId' => 4, ),
        BasePeer::TYPE_COLNAME => array (CountryPeer::ID => 0, CountryPeer::NAME => 1, CountryPeer::ISO_CODE_2 => 2, CountryPeer::ISO_CODE_3 => 3, CountryPeer::ADDRESS_FORMAT_ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ISO_CODE_2' => 2, 'ISO_CODE_3' => 3, 'ADDRESS_FORMAT_ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'iso_code_2' => 2, 'iso_code_3' => 3, 'address_format_id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountryPeer::ISO_CODE_2);
            $criteria->addSelectColumn(CountryPeer::ISO_CODE_3);
            $criteria->addSelectColumn(CountryPeer::ADDRESS_FORMAT_ID);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.NAME');
            $criteria->addSelectColumn($alias . '.ISO_CODE_2');
            $criteria->addSelectColumn($alias . '.ISO_CODE_3');
            $criteria->addSelectColumn($alias . '.ADDRESS_FORMAT_ID');
        }
    }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related Region objects
            $criteria = new Criteria(RegionPeer::DATABASE_NAME);

            $criteria->add(RegionPeer::COUNTRY_ID, $obj->getId());
            $affectedRows += RegionPeer::doDelete($criteria, $con);

            // delete related sfGuardUserProfile objects
            $criteria = new Criteria(sfGuardUserProfilePeer::DATABASE_NAME);

            $criteria->add(sfGuardUserProfilePeer::COUNTRY_ID, $obj->getId());
