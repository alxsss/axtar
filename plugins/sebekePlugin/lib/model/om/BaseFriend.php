...
abstract class BaseFriend extends BaseObject implements Persistent
{
    ...
    public function setApproved($v)
    {
        ...
        if ($this->approved !== $v) {
            $this->approved = $v;
            $this->modifiedColumns[] = FriendPeer::APPROVED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = FriendPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->asfGuardUserRelatedByFriendId !== null && $this->friend_id !== $this->asfGuardUserRelatedByFriendId->getId()) {
            $this->asfGuardUserRelatedByFriendId = null;
        }
    } // ensureConsistency
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(FriendPeer::CREATED_AT))
                {
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->asfGuardUserRelatedByFriendId !== null) {
                if ($this->asfGuardUserRelatedByFriendId->isModified() || $this->asfGuardUserRelatedByFriendId->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FriendPeer::APPROVED)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->asfGuardUserRelatedByFriendId) {
                $result['sfGuardUserRelatedByFriendId'] = $this->asfGuardUserRelatedByFriendId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FriendPeer::APPROVED)) $criteria->add(FriendPeer::APPROVED, $this->approved);
    ...
    public function getsfGuardUserRelatedByUserId(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByUserId === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->asfGuardUserRelatedByUserId->addFriendsRelatedByUserId($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setsfGuardUserRelatedByFriendId(sfGuardUser $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getsfGuardUserRelatedByFriendId(PropelPDO $con = null)
    {
        if ($this->asfGuardUserRelatedByFriendId === null && ($this->friend_id !== null)) {
            $this->asfGuardUserRelatedByFriendId = sfGuardUserQuery::create()->findPk($this->friend_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asfGuardUserRelatedByFriendId->addFriendsRelatedByFriendId($this);
             */
        }
