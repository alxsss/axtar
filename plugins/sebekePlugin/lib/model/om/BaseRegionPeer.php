...
abstract class BaseRegionPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID, RegionPeer::NAME, RegionPeer::COUNTRY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'COUNTRY_ID', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID => 0, RegionPeer::NAME => 1, RegionPeer::COUNTRY_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'COUNTRY_ID' => 2, ),
    ...
    {
        // Invalidate objects in VillagePeer instance pool,
    ...
    public static function doCountJoinCountry(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(RegionPeer::COUNTRY_ID, CountryPeer::ID, $join_behavior);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(VillagePeer::REGION_ID, $obj->getId());
            $affectedRows += VillagePeer::doDelete($criteria, $con);
        }
