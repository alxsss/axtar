...
abstract class BaseSchool extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = SchoolPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SchoolPeer::VILLAGE_ID)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aVillage) {
                $result['Village'] = $this->aVillage->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setVillageId($this->getVillageId());
    ...
    public function getVillage(PropelPDO $con = null)
    {
        if ($this->aVillage === null && ($this->village_id !== null)) {
            $this->aVillage = VillageQuery::create()->findPk($this->village_id, $con);
    ...
    public function setSchoolUsers(PropelCollection $schoolUsers, PropelPDO $con = null)
    {
        ...
        foreach ($this->schoolUsersScheduledForDeletion as $schoolUserRemoved) {
            $schoolUserRemoved->setSchool(null);
        }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseSchool:' . $name))
        {
