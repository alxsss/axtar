 ...
 * @method RegionQuery orderByCountryId($order = Criteria::ASC) Order by the country_id column
 *
 * @method RegionQuery groupById() Group by the id column
 * @method RegionQuery groupByName() Group by the name column
 * @method RegionQuery groupByCountryId() Group by the country_id column
 *
 ...
 *
 * @method RegionQuery leftJoinCountry($relationAlias = null) Adds a LEFT JOIN clause to the query using the Country relation
 * @method RegionQuery rightJoinCountry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Country relation
 * @method RegionQuery innerJoinCountry($relationAlias = null) Adds a INNER JOIN clause to the query using the Country relation
 *
 * @method RegionQuery leftJoinVillage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Village relation
 * @method RegionQuery rightJoinVillage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Village relation
 * @method RegionQuery innerJoinVillage($relationAlias = null) Adds a INNER JOIN clause to the query using the Village relation
 *
 ...
 * @method Region findOneByCountryId(int $country_id) Return the first Region filtered by the country_id column
 *
 ...
 * @method array findByCountryId(int $country_id) Return Region objects filtered by the country_id column
 *
...
abstract class BaseRegionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `NAME`, `COUNTRY_ID` FROM `region` WHERE `ID` = :p0';
        try {
    ...
    public function filterByCountryId($countryId = null, $comparison = null)
    {
        if (is_array($countryId)) {
            ...
            if (isset($countryId['min'])) {
                $this->addUsingAlias(RegionPeer::COUNTRY_ID, $countryId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($countryId['max'])) {
                $this->addUsingAlias(RegionPeer::COUNTRY_ID, $countryId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RegionPeer::COUNTRY_ID, $countryId, $comparison);
    }
    ...
    public function filterByCountry($country, $comparison = null)
    {
        if ($country instanceof Country) {
            return $this
                ->addUsingAlias(RegionPeer::COUNTRY_ID, $country->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(RegionPeer::COUNTRY_ID, $country->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   Village|PropelObjectCollection $village  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   RegionQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
    ...
    public function filterByVillage($village, $comparison = null)
    {
        if ($village instanceof Village) {
            return $this
                ->addUsingAlias(RegionPeer::ID, $village->getRegionId(), $comparison);
        } elseif ($village instanceof PropelObjectCollection) {
            return $this
                ->useVillageQuery()
                ->filterByPrimaryKeys($village->getPrimaryKeys())
                ->endUse();
        } else {
     ...
     * @return RegionQuery The current query, for fluid interface
     */
    public function joinVillage($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useVillageQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
