...
abstract class BaseUserLink extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = UserLinkPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserLinkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(UserLinkPeer::CREATED_AT))
                {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserLinkPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(UserLinkPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(UserLinkPeer::STATUS_TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`STATUS_TEXT`';
        }
        if ($this->isColumnModified(UserLinkPeer::NUM_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`NUM_COMMENT`';
        }
        if ($this->isColumnModified(UserLinkPeer::IMG)) {
            $modifiedColumns[':p' . $index++]  = '`IMG`';
        }
        if ($this->isColumnModified(UserLinkPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`URL`';
        }
        if ($this->isColumnModified(UserLinkPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`TITLE`';
        }
        if ($this->isColumnModified(UserLinkPeer::DESCRIPTION)) {
        ...
        $sql = sprintf(
            'INSERT INTO `user_link` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`USER_ID`':
                        ...
                        break;
                    case '`STATUS_TEXT`':
                        $stmt->bindValue($identifier, $this->status_text, PDO::PARAM_STR);
                        break;
                    case '`NUM_COMMENT`':
    ...
    {
        if (isset($alreadyDumpedObjects['UserLink'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserLink'][$this->getPrimaryKey()] = true;
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setStatusText($this->getStatusText());
     ...
     * If this UserLink is new, it will return
    ...
    public function setUserLinkComments(PropelCollection $userLinkComments, PropelPDO $con = null)
    {
        ...
        foreach ($this->userLinkCommentsScheduledForDeletion as $userLinkCommentRemoved) {
            $userLinkCommentRemoved->setUserLink(null);
        }
    ...
    protected function doAddUserLinkComment($userLinkComment)
    {
        ...
        $userLinkComment->setUserLink($this);
    }
    ...
    public function removeUserLinkComment($userLinkComment)
    {
        if ($this->getUserLinkComments()->contains($userLinkComment)) {
            ...
            $userLinkComment->setUserLink(null);
        }
    }
    ...
    {
        return (string) $this->exportTo(UserLinkPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseUserLink:' . $name))
        {
