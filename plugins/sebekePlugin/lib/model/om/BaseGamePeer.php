...
abstract class BaseGamePeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GamePeer::ID, GamePeer::GAME_CATEGORY_ID, GamePeer::NAME, GamePeer::DESCRIPTION, GamePeer::EMBED_CODE, GamePeer::THUMB, GamePeer::CREATIVE_SCREENSHOT, GamePeer::CREATED_AT, GamePeer::SCORE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'GAME_CATEGORY_ID', 'NAME', 'DESCRIPTION', 'EMBED_CODE', 'THUMB', 'CREATIVE_SCREENSHOT', 'CREATED_AT', 'SCORE', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GamePeer::ID => 0, GamePeer::GAME_CATEGORY_ID => 1, GamePeer::NAME => 2, GamePeer::DESCRIPTION => 3, GamePeer::EMBED_CODE => 4, GamePeer::THUMB => 5, GamePeer::CREATIVE_SCREENSHOT => 6, GamePeer::CREATED_AT => 7, GamePeer::SCORE => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'GAME_CATEGORY_ID' => 1, 'NAME' => 2, 'DESCRIPTION' => 3, 'EMBED_CODE' => 4, 'THUMB' => 5, 'CREATIVE_SCREENSHOT' => 6, 'CREATED_AT' => 7, 'SCORE' => 8, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.GAME_CATEGORY_ID');
            $criteria->addSelectColumn($alias . '.NAME');
            $criteria->addSelectColumn($alias . '.DESCRIPTION');
            $criteria->addSelectColumn($alias . '.EMBED_CODE');
            $criteria->addSelectColumn($alias . '.THUMB');
            $criteria->addSelectColumn($alias . '.CREATIVE_SCREENSHOT');
    ...
    public static function doCountJoinGameCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(GamePeer::GAME_CATEGORY_ID, GameCategoryPeer::ID, $join_behavior);
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinGameCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        GameCategoryPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + GameCategoryPeer::NUM_HYDRATE_COLUMNS;
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(GameUserPeer::GAME_ID, $obj->getId());
