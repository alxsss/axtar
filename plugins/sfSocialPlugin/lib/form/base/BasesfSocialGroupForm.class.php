...
/**
 * sfSocialGroup form base class.
 *
 * @method sfSocialGroup getObject() Returns the current form's model object
 *
 * @package    ##PROJECT_NAME##
 * @subpackage form
 * @author     ##AUTHOR_NAME##
 */
abstract class BasesfSocialGroupForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sf_social_group_user_list' => new sfWidgetFormPropelChoice(array('multiple' => true, 'model' => 'sfGuardUser')),
    ));
    ...
    $this->setValidators(array(
      ...
      'sf_social_group_user_list' => new sfValidatorPropelChoice(array('multiple' => true, 'model' => 'sfGuardUser', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('sf_social_group[%s]');
  ...
  public function savesfSocialGroupUserList($con = null)
  {
    ...
    $c = new Criteria();
    $c->add(sfSocialGroupUserPeer::GROUP_ID, $this->object->getPrimaryKey());
