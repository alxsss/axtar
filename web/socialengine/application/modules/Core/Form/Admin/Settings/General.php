  ...
  public function init()
  {
    ...
    */
    ...
    $this->getElement('staticBaseUrl')->getDecorator('Label')
        ...
        'http://anonym.to/?http://www.socialengine.net/support/article?q=188&question=How-to-use-the-CDN-Storage-Feature#maxcdn'));
    ...
    $this->getElement('analytics')->getDecorator('Label')
        ...
        ->setOptSuffix(sprintf(
        '<a class="admin help" href="%1$s" target="_blank"> </a>', 
        'http://anonym.to/?http://www.socialengine.net/support/article?q=142&question=How-to-install-Google-Analytics'));
