...
class Core_Form_Admin_Settings_Viglink extends Engine_Form
{
  public function init()
  {
    ...
    $description = vsprintf($description, array(
      ...
      'http://anonym.to/?http://www.socialengine.net/account/viglink?id=' . urlencode($subid),
      'http://anonym.to/?http://www.socialengine.net/support/article?q=206&question=Viglink-Setup'
    ));
