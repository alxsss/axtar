<?php
    ...
    abstract class Reader {
	     /**
         * the file_handle field.        
         */
        public $file_handle;
        /**
         * Initializes internal state of Reader object.        
         */
		...
		/**
         * close file handle at the end, when destructor is called.        
         */
	...
	/**
     * Subclass for reading .csv format
     */
    class CSVReader extends Reader {  
         /**
         * reads file line by line, splits line on ',' and put s values in array data.         
         * @param      array data
         * @return     void
         */	
	...
	/**
     * Subclass for reading .json format
     */
    class JsonReader extends Reader {
	   /**
         *@var  variable used to store resourse name. To be used with file content read functions        
       */
      private $file_name; 
       /**
         * Initializes internal state of JsonReader object.
         * call parent constructor for file handle validation
       */  
      public function __construct($url)
      {
       ...
       /**
         * reads whole file and parses it to array $data using json_decode function         
         * @param      array data
         * @return     void
        */	      
        public function getData(&$data)
	...
	/**     
	 * Strategy pattern to initialze appropriate class
     */    
    ...
    <div id="chart">
<?php
    //create an empty array to have reference to
    $data=array();
